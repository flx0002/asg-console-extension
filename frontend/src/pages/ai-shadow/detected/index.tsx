...
import {
  getAiShadowDetectedAccesses,
  setAiShadowDetectMode,
  getAiShadowDetectMode,
  getAiShadowDetectEvents,
  getAiShadowDetectedTrend,
  getAiShadowAuthorizedDomains,
  updateAiShadowAuthorizedDomains,
} from '@/services';
